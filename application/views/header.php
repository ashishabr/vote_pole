  ...
  <div class="container-scroller">
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item d-none d-lg-block">
            <!-- <div id="datepicker-popup" class="input-group date datepicker navbar-date-picker"> -->
              ...
              <input type="text" name="daterange" class="form-control dashboard_date" value="" />
            <!-- </div> -->
          </li>
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="mb-1 mt-3 font-weight-semibold"><?= $_SESSION['user_name']; ?></p>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('render/index'); ?>">
              <i class="mdi mdi-grid-large menu-icon"></i>
              <span class="menu-title">Dashboard</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('render/add_vote'); ?>">
              <i class="mdi mdi-gamepad-round menu-icon"></i>
              <span class="menu-title">Create Vote</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('render/list_vote'); ?>">
              <i class="mdi mdi-format-align-justify menu-icon"></i>
              <span class="menu-title">List Vote</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('render/view_vote'); ?>">
              <i class="mdi mdi-layers menu-icon"></i>
              <span class="menu-title">View Vote</span>
            </a>
          </li>
